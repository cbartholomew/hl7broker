...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [SHIELDS_INTERFACE_BROKER], FILENAME = 'D:\MSSQL11.MSSQLSERVER\MSSQL\DATA\SHIELDS_INTERFACE_BROKER.mdf')
    LOG ON (NAME = [SHIELDS_INTERFACE_BROKER_log], FILENAME = 'E:\MSSQL11.MSSQLSERVER\MSSQL\LOG\SHIELDS_INTERFACE_BROKER_log.ldf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
IF EXISTS (SELECT 1
...
GO
ALTER TABLE [dbo].[SYS_COLUMN_SET]
...
GO
ALTER TABLE [dbo].[SYS_COMMUNICATION]
...
GO
ALTER TABLE [dbo].[SYS_CREDENTIAL]
...
GO
ALTER TABLE [dbo].[SYS_DATABASE_INSTANCE]
...
GO
ALTER TABLE [dbo].[SYS_DATABASE_TABLE]
...
GO
ALTER TABLE [dbo].[SYS_DATABASE_TABLE_RELATION]
...
GO
ALTER TABLE [dbo].[SYS_MESSAGE_GROUP]
...
GO
ALTER TABLE [dbo].[SYS_MESSAGE_GROUP_INSTANCE]
...
GO
ALTER TABLE [dbo].[SYS_WEBSERVICE_INSTANCE]
...
GO
ALTER TABLE [dbo].[SYS_WEBSERVICE_OBJECT]
...
GO
ALTER TABLE [dbo].[SYS_WEBSERVICE_PROPERTY_SET]
